  ...
  object HelpPanel: TPanel
    ...
    object HelpMemo: TMemo
      ...
      Lines.Strings = (
        ...
        '          []] - literal ]'
        ''
        'Everything not inside square brackets is treated as '
        'literal text, unknown placeholders are ignored.'
        ''
        'Examples:'
        ''
